...
const mockMachines = {
  '1': { _id: '1', name: 'John Deere 8RX', category: 'Tractors', price: 320000, description: 'The 8RX is designed to minimize soil compaction and maximize power. Experience a smooth ride and advanced precision ag technology.', images: ['/images/WhatsApp Image 2026-04-09 at 11.50.45 AM.jpeg'], specs: { power: '410 hp', usage: 'Heavy plowing, large scale operations', engine: '9.0L 6-Cylinder' } },
  '2': { _id: '2', name: 'Case IH Axial-Flow', category: 'Harvesters', price: 450000, description: 'Ultimate harvesting efficiency with minimal grain loss. Automated settings adjust to conditions on-the-go.', images: ['/images/WhatsApp Image 2026-04-09 at 11.50.46 AM.jpeg'], specs: { power: '550 hp', usage: 'Wheat, Corn harvesting', engine: '12.9L FPT' } },
  '3': { _id: '3', name: 'Valley Center Pivot', category: 'Irrigation', price: 150000, description: 'The most reliable center pivot system in the industry, featuring smart telemetry for remote water management.', images: ['/images/WhatsApp Image 2026-04-09 at 11.50.47 AM.jpeg'], specs: { power: 'Electric 480V', usage: 'Large scale watering', length: 'Up to 2,800 ft' } },
  '4': { _id: '4', name: 'Massey Ferguson 8S', category: 'Tractors', price: 210000, description: 'Award-winning design featuring the Protect-U cab installation for superior comfort and visibility.', images: ['/images/WhatsApp Image 2026-04-09 at 11.50.46 AM (1).jpeg'], specs: { power: '265 hp', usage: 'General farm work', transmission: 'Dyna-E-Power' } }
};
